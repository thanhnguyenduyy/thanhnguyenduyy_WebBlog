<div class="w-64 h-full bg-white dark:bg-brand-panel border-r border-zinc-200 dark:border-brand-border flex flex-col flex-shrink-0 relative z-20 transition-colors duration-300">
    ...
    <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
        ...
        @php
            $navItems = [
                ...
                ['id' => 'gallery_categories', 'label' => 'Gallery Categories', 'icon' => 'folder', 'route' => 'admin.gallery-categories.index'],
                ['id' => 'projects', 'label' => 'IT Projects', 'icon' => 'briefcase', 'route' => 'admin.projects.index'],
                ['id' => 'timeline', 'label' => 'Experience', 'icon' => 'clock', 'route' => 'admin.timeline.index'],
    ...
    <div class="p-4 border-t border-zinc-200 dark:border-brand-border/50 bg-white dark:bg-brand-panel">
        <button onclick="toggleTheme()" class="w-full flex items-center px-3 py-2 mb-1 text-zinc-500 hover:text-zinc-900 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-zinc-800/50 rounded-lg transition-colors">
