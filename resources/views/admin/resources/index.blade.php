...
<div class="space-y-6 h-full flex flex-col animate-in">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-4">
        ...
        <div class="group bg-white dark:bg-brand-panel border border-zinc-200 dark:border-brand-border p-5 rounded-xl flex items-center justify-between hover:border-brand-blue/30 transition-all shadow-sm dark:shadow-none">
            <div class="flex items-center gap-4">
                <div class="w-12 h-12 bg-zinc-100 dark:bg-zinc-900 rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    @else
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-zinc-500"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg>
                    @endif
                </div>
                <div>
                    <h3 class="text-zinc-900 dark:text-white font-medium text-lg leading-tight">{{ $resource->title }}</h3>
                    <p class="text-zinc-500 text-xs mt-1">{{ $resource->description }}</p>
                </div>
            </div>
        ...
        @empty
        <div class="col-span-full text-center py-20 border-2 border-dashed border-zinc-200 dark:border-zinc-800 rounded-3xl">
            <p class="text-zinc-500 font-serif italic text-lg">No resources found. Add your first digital item.</p>
        </div>
        @endforelse
    </div>

    <div class="mt-auto pt-12 flex justify-center pb-8">
